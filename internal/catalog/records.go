...
func tombstone(id, domain, summary, docs, path, replacement string, billing BillingGroup) Capability {
	return Capability{
		...
		Target:       TargetNone,
		Upstream:     upstream(path, ResponseLegacyV1),
		BillingGroup: billing,
...
func records() []Capability {
	...
	return []Capability{
		current(
			...
			upstream("/geo/v2/city/lookup", ResponseLegacyV1), BillingBasic, GateNone, geoCache,
		),
		current(
			...
			upstream("/geo/v2/city/top", ResponseLegacyV1), BillingBasic, GateNone, geoCache,
		),
		current(
			...
			upstream("/geo/v2/poi/lookup", ResponseLegacyV1), BillingBasic, GateNone, geoCache,
		),
		current(
			...
			upstream("/geo/v2/poi/range", ResponseLegacyV1), BillingBasic, GateNone, geoCache,
		),
		...
		current(
			...
			placeFlags(true, false), upstream("/v7/weather/now", ResponseLegacyV1),
		...
		current(
			...
			upstream("/v7/weather/{days}", ResponseLegacyV1), BillingBasic, GateNone,
		...
		current(
			...
			upstream("/v7/weather/{hours}", ResponseLegacyV1), BillingBasic, GateNone,
		...
		current(
			...
			placeFlags(true, true), upstream("/v7/grid-weather/now", ResponseLegacyV1),
			BillingBasic, GateNone, basic10m,
		),
		current(
			...
			upstream("/v7/grid-weather/{days}", ResponseLegacyV1), BillingBasic, GateNone,
		...
		current(
			...
			upstream("/v7/grid-weather/{hours}", ResponseLegacyV1), BillingBasic, GateNone,
		...
		current(
			...
			placeFlags(true, false), upstream("/v7/minutely/5m", ResponseLegacyV1),
		...
		current(
			...
			upstream("/v7/indices/{days}", ResponseLegacyV1), BillingBasic, GateNone,
		...
		current(
			...
			upstream("/v7/historical/weather", ResponseLegacyV1), BillingBasic, GateNone,
		...
		current(
			...
			upstream("/weatheralert/v1/current/{latitude}/{longitude}", ResponseModernV1),
			BillingBasic, GateNone, policy(CacheEnabled, 5*time.Minute, BoundaryNone, evidenceOfficial),
		),
		...
		current(
			...
			placeFlags(true, false), upstream("/airquality/v1/current/{latitude}/{longitude}", ResponseModernV1),
		...
		current(
			...
			placeFlags(true, false), upstream("/airquality/v1/daily/{latitude}/{longitude}", ResponseModernV1),
		...
		current(
			...
			placeFlags(true, false), upstream("/airquality/v1/hourly/{latitude}/{longitude}", ResponseModernV1),
		...
		current(
			...
			upstream("/airquality/v1/stations/{locationId}", ResponseModernV1), BillingBasic, GateNone, basic30m,
		),
		...
		current(
			...
			upstream("/v7/tropical/storm-track", ResponseLegacyV1), BillingMarine, GateMarine,
			CachePolicy{Mode: CacheEnabled, TTL: 20 * time.Minute, InactiveTTL: time.Hour, Boundary: BoundaryNone, Evidence: evidenceOfficial},
		),
		current(
			...
			[]Flag{stringFlag("storm-id", "QWeather storm ID", true), allowMarine},
			upstream("/v7/tropical/storm-forecast", ResponseLegacyV1), BillingMarine, GateMarine,
			CachePolicy{Mode: CacheEnabled, TTL: 20 * time.Minute, InactiveTTL: time.Hour, Boundary: BoundaryNone, Evidence: evidenceOfficial},
		),
		current(
		...
		current(
			...
			upstream("/v7/astronomy/solar-elevation-angle", ResponseLegacyV1), BillingBasic, GateNone,
			policy(CacheEnabled, 24*time.Hour, BoundaryNone, evidenceConservative),
		),
		current(
